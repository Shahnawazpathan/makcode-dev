...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/shahnawaz-pathan/makcode/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for shahnawaz-pathan/makcode...\n")
...
console.log("Fetching npm all-time downloads for makcode-ai...\n")
const npmDownloads = await fetchNpmDownloads("makcode-ai")
