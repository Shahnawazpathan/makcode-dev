...
Generates UPCOMING_CHANGELOG.md by running the makcode changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for makcode run (default: low)
      --quiet            Suppress makcode command output unless it fails
