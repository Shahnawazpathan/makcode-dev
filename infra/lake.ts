...
const tableBucketName = `makcode-${$app.stage}-lake`
...
const firehose = new aws.kinesis.FirehoseDeliveryStream(
  "LakeFirehose",
  {
    name: `makcode-${$app.stage}-lake-ingest`,
    destination: "iceberg",
