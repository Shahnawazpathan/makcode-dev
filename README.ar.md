<p align="center">
  <a href="https://makcode.ai">
    <picture>
      ...
      <img src="packages/console/app/src/asset/logo-ornate-light.svg" alt="شعار MakCode">
    </picture>
  </a>
</p>
...
# مديري الحزم
npm i -g makcode-ai@latest        # او bun/pnpm/yarn
scoop install makcode             # Windows
choco install makcode             # Windows
brew install shahnawaz-pathan/tap/makcode # macOS و Linux (موصى به، دائما محدث)
brew install makcode              # macOS و Linux (صيغة brew الرسمية، تحديث اقل)
sudo pacman -S makcode            # Arch Linux (Stable)
paru -S makcode-bin               # Arch Linux (Latest from AUR)
mise use -g makcode               # اي نظام
nix run nixpkgs#makcode           # او github:shahnawaz-pathan/makcode لاحدث فرع dev
```
...
يتوفر MakCode ايضا كتطبيق سطح مكتب. قم بالتنزيل مباشرة من [صفحة الاصدارات](https://github.com/shahnawaz-pathan/makcode/releases) او من [makcode.ai/download](https://makcode.ai/download).
...
4. `$HOME/.makcode/bin` - المسار الافتراضي الاحتياطي
...
يتضمن MakCode وكيليْن (Agents) مدمجين يمكنك التبديل بينهما باستخدام زر `Tab`.
...
تعرف على المزيد حول [agents](https://makcode.ai/docs/agents).

### التوثيق

لمزيد من المعلومات حول كيفية ضبط MakCode، [**راجع التوثيق**](https://makcode.ai/docs).

### المساهمة

اذا كنت مهتما بالمساهمة في MakCode، يرجى قراءة [contributing docs](./CONTRIBUTING.md) قبل ارسال pull request.

### البناء فوق MakCode

اذا كنت تعمل على مشروع مرتبط بـ MakCode ويستخدم "makcode" كجزء من اسمه (مثل "makcode-dashboard" او "makcode-mobile")، يرجى اضافة ملاحظة في README توضح انه ليس مبنيا بواسطة فريق MakCode ولا يرتبط بنا بأي شكل.

---

**انضم الى مجتمعنا** [Discord](https://discord.gg/makcode) | [X.com](https://x.com/makcode)
