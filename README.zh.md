...
brew install shahnawaz-pathan/tap/makcode # macOS 和 Linux（推荐，始终保持最新）
brew install makcode              # macOS 和 Linux（官方 brew formula，更新频率较低）
sudo pacman -S makcode            # Arch Linux (Stable)
paru -S makcode-bin               # Arch Linux (Latest from AUR)
mise use -g makcode               # 任意系统
nix run nixpkgs#makcode           # 或用 github:shahnawaz-pathan/makcode 获取最新 dev 分支
```
...
MakCode 也提供桌面版应用。可直接从 [发布页 (releases page)](https://github.com/shahnawaz-pathan/makcode/releases) 或 [makcode.ai/download](https://makcode.ai/download) 下载。
...
MakCode 内置两种 Agent，可用 `Tab` 键快速切换：
...
了解更多 [Agents](https://makcode.ai/docs/agents) 相关信息。

### 文档

更多配置说明请查看我们的 [**官方文档**](https://makcode.ai/docs)。
...
如果你在项目名中使用了 “makcode”（如 “makcode-dashboard” 或 “makcode-mobile”），请在 README 里注明该项目不是 MakCode 团队官方开发，且不存在隶属关系。

---

**加入我们的社区** [飞书](https://applink.feishu.cn/client/chat/chatter/add_by_link?link_token=738j8655-cd59-4633-a30a-1124e0096789&qr_code=true) | [X.com](https://x.com/makcode)
