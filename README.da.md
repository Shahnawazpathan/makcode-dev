...
MakCode findes også som desktop-app. Download direkte fra [releases-siden](https://github.com/Shahnawazpathan/makcode-dev/releases) eller [opencode.ai/download](https://opencode.ai/download).
...
For mere info om konfiguration af MakCode, [**se vores docs**](https://opencode.ai/docs).
