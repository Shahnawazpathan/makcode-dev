...
- Effect plugins import `@makcode-ai/plugin/v2/effect`, not `@makcode-ai/core`.
- Public domain values use generated `@makcode-ai/sdk` types.
...
- Define `PluginHost` domain capabilities in `@makcode-ai/plugin/v2/effect`.
