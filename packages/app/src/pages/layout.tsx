...
import { getFilename } from "@makcode-ai/core/util/path"
import { Session } from "@makcode-ai/sdk/v2/client"
...
import { toaster } from "@makcode-ai/ui/toast"
...
import { retry } from "@makcode-ai/core/util/retry"
...
import { useTheme, type ColorScheme } from "@makcode-ai/ui/theme/context"
...
export default function LegacyLayout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://github.com/Shahnawazpathan/makcode-dev/issues")}
      renderPanel={() =>
