export const dict = {
  ...
  "wsl.onboarding.step.opencode": "MakCode",
  ...
  "wsl.onboarding.opencodeReadyIn": "MakCode is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "MakCode is ready.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MakCode not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before MakCode can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "MakCode could not verify WSL on this machine.",
