export const dict = {
  ...
  "dialog.provider.makcode.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.makcode.tagline": "Reliable optimized models",
  "dialog.provider.makcodeGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by MakCode",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in MakCode.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.makcodeZen.line1":
    "MakCode Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.makcodeZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.makcodeZen.visit.prefix": "Visit ",
  "provider.connect.makcodeZen.visit.link": "makcode.ai/zen",
  "provider.connect.makcodeZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in MakCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in MakCode.",
  ...
  "dialog.plugins.empty": "Plugins configured in makcode.json",
  ...
  "dialog.server.description": "Switch which MakCode server this app connects to.",
  ...
  "wsl.onboarding.step.makcode": "MakCode",
  ...
  "wsl.onboarding.checkingOpencode": "Checking MakCode...",
  "wsl.onboarding.checkingOpencodeIn": "Checking MakCode in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating MakCode...",
  "wsl.onboarding.updatingOpencodeIn": "Updating MakCode in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update MakCode in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update MakCode",
  "wsl.onboarding.makcodeReadyIn": "MakCode is ready in {{distro}}.",
  "wsl.onboarding.makcodeReady": "MakCode is ready.",
  "wsl.onboarding.installOpencodeIn": "Install MakCode in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install MakCode",
  ...
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen MakCode.",
  ...
  "toast.update.description": "A new version of MakCode ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the MakCode team",
  ...
  "error.chain.checkConfig": "Check your config (makcode.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, MakCode does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "MakCode includes free models so you can start immediately.",
  ...
  "app.name.desktop": "MakCode Desktop",
  ...
  "settings.desktop.wsl.description": "Run the MakCode server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for MakCode",
  ...
  "settings.general.row.appearance.description": "Customise how MakCode looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether MakCode follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how MakCode is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when MakCode launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of MakCode.",
