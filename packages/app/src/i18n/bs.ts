export const dict = {
  ...
  "dialog.provider.makcode.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.makcode.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.makcodeGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje MakCode",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u MakCode-u.",
  ...
  "provider.connect.makcodeZen.line1":
    "MakCode Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  "provider.connect.makcodeZen.line2":
    "Sa jednim API ključem dobijaš pristup modelima kao što su Claude, GPT, Gemini, GLM i drugi.",
  "provider.connect.makcodeZen.visit.prefix": "Posjeti ",
  "provider.connect.makcodeZen.visit.link": "makcode.ai/zen",
  "provider.connect.makcodeZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u MakCode-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u MakCode-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u makcode.json",
  ...
  "dialog.server.description": "Promijeni na koji se MakCode server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija MakCode-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku MakCode timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (makcode.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: MakCode još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "MakCode uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni MakCode server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u MakCode-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako MakCode izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li MakCode prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu MakCode-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se MakCode pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju MakCode-a.",
