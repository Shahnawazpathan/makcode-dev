export const dict = {
  ...
  "dialog.provider.makcode.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.makcode.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.makcodeGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez MakCode",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w MakCode.",
  ...
  "provider.connect.makcodeZen.line1":
    "MakCode Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.makcodeZen.visit.prefix": "Odwiedź ",
  "provider.connect.makcodeZen.visit.link": "makcode.ai/zen",
  "provider.connect.makcodeZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w MakCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w MakCode.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w makcode.json",
  ...
  "dialog.server.description": "Przełącz serwer MakCode, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja MakCode ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu MakCode",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (makcode.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "MakCode zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla MakCode",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd MakCode na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy MakCode ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw MakCode.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania MakCode",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji MakCode.",
