...
beforeAll(async () => {
  ...
  mock.module("@makcode-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@makcode-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@makcode-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@makcode-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
