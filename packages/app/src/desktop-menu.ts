...
export const DESKTOP_MENU: DesktopMenu[] = [
  ...
  },
  {
    ...
    label: "Help",
    items: [
      { type: "item", label: "MakCode Documentation", href: "https://makcode.ai/docs" },
      ...
      { type: "separator" },
      {
        ...
        href: "https://github.com/shahnawaz-pathan/makcode/issues/new?template=feature_request.yml",
      },
      {
        type: "item",
        label: "Report a Bug",
        href: "https://github.com/shahnawaz-pathan/makcode/issues/new?template=bug_report.yml",
      },
    ],
  },
]
