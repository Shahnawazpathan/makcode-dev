...
export const DESKTOP_MENU: DesktopMenu[] = [
  ...
  },
  {
    ...
    label: "Help",
    items: [
      { type: "item", label: "MakCode Documentation", href: "https://github.com/Shahnawazpathan/makcode-dev" },
      { type: "item", label: "Support Forum", href: "https://github.com/Shahnawazpathan/makcode-dev/discussions" },
      { type: "item", label: "Export Logs...", command: "logs.export" },
      { type: "separator" },
      {
        type: "item",
        label: "Share Feedback",
        href: "https://github.com/Shahnawazpathan/makcode-dev/issues/new",
      },
      {
        type: "item",
        label: "Report a Bug",
