...
import type { ProviderAuthAuthorization, ProviderAuthMethod } from "@makcode-ai/sdk/v2"
    ...
    const value = await DialogPrompt.show(dialog, "Other", {
      ...
      description: () => (
        <text fg={theme.textMuted}>
          This only stores a credential. Configure the provider in your MakCode config to use it.
        </text>
      ),
    })
    ...
    <DialogPrompt
      ...
      description={
        {
          opencode: (
            <box gap={1}>
              ...
              <text fg={theme.text}>
                Go to your MakCode account page to get a key
              </text>
            </box>
          ),
          "opencode-go": (
            <box gap={1}>
              ...
              <text fg={theme.text}>
                Go to your MakCode account page and enable MakCode Go
              </text>
            </box>
          ),
      ...
      onConfirm={async (value) => {
        ...
        if (props.custom && !sync.data.provider_next.all.some((provider) => provider.id === props.providerID)) {
          toast.show({
            variant: "info",
            message: `Saved credential for ${props.providerID}. Configure it in your MakCode config to use it.`,
          })
          dialog.clear()
          return
        }
