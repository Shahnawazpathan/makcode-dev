...
export function ErrorComponent(props: { error: Error; reset: () => void; mode?: "dark" | "light" }) {
  ...
  const issueURL = new URL("https://github.com/shahnawaz-pathan/makcode/issues/new?template=bug-report.yml")
  ...
  issueURL.searchParams.set("makcode-version", InstallationVersion)
