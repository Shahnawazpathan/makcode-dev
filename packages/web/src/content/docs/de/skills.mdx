...
Agent Skills erlauben MakCode, wiederverwendbare Anweisungen aus deinem Repo oder Home-Verzeichnis zu finden.
...
MakCode sucht in folgenden Pfaden:
...
Bei projektlokalen Pfaden laeuft MakCode vom aktuellen Verzeichnis nach oben bis zum Git-Worktree.
...
MakCode listet verfuegbare Skills in der Beschreibung des `skill`-Tools.
