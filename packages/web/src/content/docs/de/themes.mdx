...
Mit MakCode kannst du ein eingebautes Theme waehlen, ein an dein Terminal angepasstes Theme nutzen oder ein eigenes Theme definieren.

Standardmaessig verwendet MakCode das `opencode`-Theme.
...
MakCode liefert mehrere eingebaute Themes mit.
...
- MakCode optisch ans Terminal anpassen wollen
...
MakCode unterstuetzt ein flexibles JSON-basiertes Theme-System.
