---
title: TUI
description: Arbeite mit MakCode in der Terminal-Oberflaeche.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

MakCode bietet eine interaktive Terminaloberflaeche (TUI), um mit einem LLM an deinen Projekten zu arbeiten.

Ohne weitere Argumente startet MakCode die TUI im aktuellen Verzeichnis.
...
In der MakCode-TUI kannst du `/` plus Befehlsnamen eingeben, um Aktionen schnell auszufuehren.
Zum Beispiel:
...
Fuegt einen Provider zu MakCode hinzu. Erlaubt die Auswahl aus verfuegbaren Providern und das Hinzufuegen ihrer API-Keys.
...
Beendet MakCode. _Aliase_: `/quit`, `/q`
...
- `leader_timeout` - Steuert, wie lange MakCode nach der leader key wartet. Standard ist `2000`.
