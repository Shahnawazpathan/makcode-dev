---
title: LSP Server
description: MakCode lässt sich in Ihren LSP-Server integrieren.
---

MakCode kann sich in Language Server Protocol (LSP)-Server integrieren, um Diagnosen als Feedback für den Agenten zu verwenden.

---

## Integriert

MakCode verfügt über mehrere integrierte LSP-Server für gängige Sprachen:
...
Wenn LSP aktiviert ist und MakCode eine Datei öffnet, geschieht Folgendes:
...
Sie können LSP-Server über den Abschnitt `lsp` in Ihrer MakCode-Konfiguration aktivieren und anpassen.
