...
description: Erstellen Sie Tools, die der LLM in MakCode aufrufen kann.
---

Benutzerdefinierte Tools sind von Ihnen erstellte Funktionen, die der LLM während Gesprächen aufrufen kann. Sie arbeiten neben [built-in tools](/docs/tools) von MakCode wie `read`, `write` und `bash`.
