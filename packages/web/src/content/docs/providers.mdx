...
1. Run the `/connect` command in the TUI, select `MakCode Zen`, and head to [opencode.ai/auth](https://opencode.ai/zen).
...
1. Run the `/connect` command in the TUI, select `MakCode Go`, and head to [opencode.ai/auth](https://opencode.ai/zen).
