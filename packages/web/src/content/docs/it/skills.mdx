...
Le skill degli agenti permettono a MakCode di individuare istruzioni riutilizzabili dal tuo repo o dalla home directory.
...
MakCode cerca in queste posizioni:
...
Per i percorsi locali al progetto, MakCode risale dalla directory di lavoro corrente finche' non raggiunge il worktree git.
...
MakCode elenca le skill disponibili nella descrizione dello strumento `skill`.
