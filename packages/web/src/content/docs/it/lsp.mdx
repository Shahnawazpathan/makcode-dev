---
title: Server LSP
description: MakCode si integra con i tuoi server LSP.
---

MakCode può integrarsi con server Language Server Protocol (LSP) per usare la diagnostica come feedback per l'agente.

---

## Integrati

MakCode include diversi server LSP integrati per linguaggi popolari:
