---
title: Tjener
description: Samhandle med MakCode-tjener over HTTP.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Kommandoen `opencode serve` kjører en hodeløs HTTP-server som eksponerer et OpenAPI-endepunkt som en MakCode-klient kan bruke.
...
:::tip
Bruk MakCode-serveren til å samhandle med MakCode programmatisk.
:::

Denne arkitekturen lar MakCode støtte flere klienter og lar deg samhandle med MakCode programmatisk.

Du kan kjøre `opencode serve` for å starte en frittstående server. Hvis du har
MakCode TUI kjører, vil `opencode serve` starte en ny server.
...
[`/tui`](#tui) endepunktet kan brukes til å kjøre TUI gjennom serveren. Du kan for eksempel forhåndsutfylle eller kjøre en forespørsel. Dette oppsettet brukes av MakCode [IDE](/docs/ide) plugins.
