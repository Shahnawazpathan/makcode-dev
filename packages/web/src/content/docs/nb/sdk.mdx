---
title: SDK
description: Typesikker JS-klient for MakCode-server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

MakCode JS/TS SDK gir en typesikker klient for samhandling med serveren.
Bruk den til å bygge integrasjoner og kontrollere MakCode programmatisk.
...
Opprett en forekomst av MakCode:
...
Hvis du allerede har en kjørende forekomst av MakCode, kan du opprette en klientforekomst for å koble til den:
