---
title: LSP Servers
description: MakCode integrates with your LSP servers.
---

MakCode can integrate with Language Server Protocol (LSP) servers to use diagnostics as feedback for the agent.

---

## Built-in

MakCode comes with several built-in LSP servers for popular languages:
