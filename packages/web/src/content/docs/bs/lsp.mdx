---
title: LSP serveri
description: MakCode se integriše sa vašim LSP serverima.
---

MakCode se može integrisati sa Language Server Protocol (LSP) serverima kako bi koristio dijagnostiku kao feedback za agenta.

## Ugrađeni

MakCode dolazi sa nekoliko ugrađenih LSP servera za popularne jezike:
