...
Agent skills omogucavaju MakCode da pronade uputstva koja se mogu ponovo koristiti iz repozitorija ili home direktorija.
...
MakCode pretrazuje ove lokacije:
...
Za projektne lokalne putanje, MakCode ide prema gore od trenutnog radnog direktorija dok ne dode do git worktree-ja.
...
MakCode navodi dostupne skills u opisu `skill` alata.
