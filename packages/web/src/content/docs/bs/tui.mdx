---
title: TUI
description: Korištenje korisničkog interfejsa MakCode terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

MakCode pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje MakCode pokreće TUI za trenutni direktorij.
...
Kada koristite MakCode TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u MakCode. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz MakCode. _Aliases_: `/quit`, `/q`
...
- `leader_timeout` - Kontroliše koliko dugo MakCode čeka nakon leader key. Podrazumijevano je `2000`.
