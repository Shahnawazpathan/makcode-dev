...
U MakCode mozete birati izmedu vise ugradenih tema, koristiti temu koja se prilagodava terminalu ili definisati vlastitu temu.

Po defaultu, MakCode koristi nasu `opencode` temu.
...
MakCode dolazi sa vise ugradenih tema.
...
- Zele da MakCode odgovara izgledu njihovog terminala
...
MakCode podrzava fleksibilan sistem tema baziran na JSON-u koji olaksava kreiranje i prilagodavanje tema.
