...
With MakCode you can select from one of several built-in themes, use a theme that adapts to your terminal theme, or define your own custom theme.

By default, MakCode uses our own `opencode` theme.
...
MakCode comes with several built-in themes.
...
- Want MakCode to match their terminal's appearance
...
MakCode supports a flexible JSON-based theme system that allows users to create and customize themes easily.
