...
Puede agregar comandos personalizados a través de la configuración MakCode o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su MakCode [config](/docs/config):
