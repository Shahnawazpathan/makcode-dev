...
Las habilidades del agente permiten a MakCode descubrir instrucciones reutilizables de su repositorio o directorio de inicio.
...
MakCode busca estas ubicaciones:
...
Para las rutas locales del proyecto, MakCode sube desde su directorio de trabajo actual hasta llegar al árbol de trabajo de git.
...
MakCode enumera las habilidades disponibles en la descripción de la herramienta `skill`.
