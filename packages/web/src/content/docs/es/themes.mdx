...
Con MakCode puede seleccionar uno de varios temas integrados, usar un tema que se adapte al tema de su terminal o definir su propio tema personalizado.

De forma predeterminada, MakCode usa nuestro propio tema `opencode`.
...
MakCode viene con varios temas integrados.
...
- Quiere que MakCode coincida con la apariencia de su terminal
...
MakCode admite un sistema de temas flexible basado en JSON que permite a los usuarios crear y personalizar temas fácilmente.
