---
title: TUI
description: Usando la interfaz de usuario del terminal MakCode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

MakCode proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar MakCode se inicia TUI para el directorio actual.
...
Cuando utilice MakCode TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a MakCode. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Salga de MakCode. _Alias_: `/quit`, `/q`
...
- `leader_timeout`: controla cuánto tiempo espera MakCode después de la leader key. El valor predeterminado es `2000`.
