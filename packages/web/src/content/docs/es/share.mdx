---
title: Compartir
description: Comparte tus conversaciones MakCode.
---

La función para compartir de MakCode te permite crear enlaces públicos a tus conversaciones de MakCode, para que puedas colaborar con compañeros de equipo u obtener ayuda de otros.
...
Cuando compartes una conversación, MakCode:
...
MakCode admite tres modos de compartir que controlan cómo se comparten las conversaciones:

---

### Manual (predeterminado)

De forma predeterminada, MakCode usa el modo de compartir manual. Las sesiones no se comparten automáticamente, pero puedes compartirlas manualmente usando el comando `/share`:
