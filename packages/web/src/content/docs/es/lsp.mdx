...
description: MakCode se integra con sus servidores LSP.
---

MakCode puede integrarse con servidores Language Server Protocol (LSP) para usar diagnósticos como feedback para el agente.

---

## Incorporados

MakCode viene con varios servidores LSP integrados para idiomas populares:
