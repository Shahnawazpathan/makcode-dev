---
title: Soporte ACP
description: Utilice MakCode en cualquier editor compatible con ACP.
---

MakCode admite el [Agent Client Protocol](https://agentclientprotocol.com) o (ACP), lo que le permite usarlo directamente en editores e IDE compatibles.
...
Para usar MakCode a través de ACP, configure su editor para ejecutar el comando `opencode acp`.

El comando inicia MakCode como un subproceso compatible con ACP que se comunica con su editor a través de JSON-RPC a través de stdio.
...
Para abrirlo, use el nuevo agente 'MakCode' en el selector de agentes de AI Chat.
...
Para usar MakCode como agente ACP en [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), agregue lo siguiente a su configuración de Neovim:
...
Esta configuración configura CodeCompanion para usar MakCode como agente ACP para el chat.
...
MakCode funciona igual a través de ACP que en la terminal. Todas las funciones son compatibles:
...
- Servidores MCP configurados en su configuración MakCode
