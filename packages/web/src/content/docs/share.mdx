---
title: Share
description: Share your MakCode conversations.
---

MakCode's share feature allows you to create public links to your MakCode conversations, so you can collaborate with teammates or get help from others.
...
When you share a conversation, MakCode:
...
MakCode supports three sharing modes that control how conversations are shared:

---

### Manual (default)

By default, MakCode uses manual sharing mode. Sessions are not shared automatically, but you can manually share them using the `/share` command:
