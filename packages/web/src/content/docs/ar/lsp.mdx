---
title: خوادم LSP
description: يتكامل MakCode مع خوادم LSP لديك.
---

يمكن أن يتكامل MakCode مع خوادم Language Server Protocol (LSP) لاستخدام التشخيصات كملاحظات للوكيل.

---

## المدمجة

يأتي MakCode مع عدة خوادم LSP مدمجة للغات الشائعة:
