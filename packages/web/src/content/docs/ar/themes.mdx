...
مع MakCode يمكنك الاختيار من بين عدة سمات مدمجة، أو استخدام سمة تتكيّف مع سمة terminal لديك، أو تعريف سمة مخصصة خاصة بك.

افتراضيًا، يستخدم MakCode سمتنا `opencode`.
...
يأتي MakCode مع عدة سمات مدمجة.
...
- يريدون أن يطابق MakCode مظهر terminal لديهم
...
يدعم MakCode نظام سمات مرنًا قائمًا على JSON يتيح للمستخدمين إنشاء السمات وتخصيصها بسهولة.
