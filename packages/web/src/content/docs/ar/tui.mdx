---
title: TUI
description: استخدام واجهة المستخدم TUI في MakCode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر MakCode واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل MakCode إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة MakCode في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى MakCode. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من MakCode. _الأسماء المستعارة_: `/quit`, `/q`
...
- `leader_timeout` - يتحكم في مدة انتظار MakCode بعد الضغط على leader key. القيمة الافتراضية `2000`.
