...
Agent skills let MakCode discover reusable instructions from your repo or home directory.
...
MakCode searches these locations:
...
For project-local paths, MakCode walks up from your current working directory until it reaches the git worktree.
...
MakCode lists available skills in the `skill` tool description.
