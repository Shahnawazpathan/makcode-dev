...
You can add custom commands through the MakCode config or by creating markdown files in the `commands/` directory.

---

### JSON

Use the `command` option in your MakCode [config](/docs/config):
