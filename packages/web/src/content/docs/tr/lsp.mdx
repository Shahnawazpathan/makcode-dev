...
description: MakCode, LSP sunucularınızla bütünleşir.
---

MakCode, tanılamayı agent için geri bildirim olarak kullanmak üzere Language Server Protocol (LSP) sunucularıyla bütünleşebilir.

---

## Yerleşik

MakCode, popüler diller için çeşitli yerleşik LSP sunucularıyla birlikte gelir:
