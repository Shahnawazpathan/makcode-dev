...
Les compétences d'agent permettent à MakCode de découvrir des instructions réutilisables à partir de votre dépôt ou de votre répertoire personnel.
...
MakCode recherche ces emplacements :
...
Pour les chemins locaux du projet, MakCode remonte de votre répertoire de travail actuel jusqu'à ce qu'il atteigne l'arbre de travail git.
...
MakCode répertorie les compétences disponibles dans la description de l'outil `skill`.
