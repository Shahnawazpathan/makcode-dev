...
Vous pouvez ajouter des commandes personnalisées via la configuration MakCode ou en créant des fichiers markdown dans le répertoire `commands/`.

---

### JSON

Utilisez l'option `command` dans votre MakCode [config](/docs/config) :
