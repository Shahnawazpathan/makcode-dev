...
Agentferdigheter lar MakCode oppdage gjenbrugbare instruksjoner fra repo- eller hjemmekatalogen din.
...
MakCode søker etter disse stedene:
...
For prosjektlokale stier går MakCode opp fra din nåværende arbejdskatalog til den når git-arbeidstreet.
...
MakCode viser tilgængelige ferdigheter i `skill` verktøybeskrivelsen.
