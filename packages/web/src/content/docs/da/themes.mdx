...
Med MakCode kan du velge fra ett av flere innebygde temaer, bruge et tema som tilpasser seg terminaltemaet ditt, eller definere ditt eget tilpassede tema.

Som standard bruger MakCode vårt eget `opencode`-tema.
...
MakCode kommer med flere innebygde temaer.
...
- Vil at MakCode skal matche terminalens utseende
...
MakCode støtter et fleksibelt JSON-basert temasystem som lar brugere enkelt lage og tilpasse temaer.
