...
Du kan tilføje brugerdefinerede kommandoer gennem MakCode-konfigurationen eller ved at oprette markdown-filer i `commands/`-mappen.

---

### JSON

Brug indstillingerne `command` i din MakCode [config](/docs/config):
