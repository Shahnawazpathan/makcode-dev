---
title: Deling
description: Del dine MakCode-samtaler.
---

MakCodes delingsfunksjon lar deg lage offentlige lenker til dine MakCode-samtaler, slik at du kan samarbeide med lagkamerater eller få hjelp fra andre.
...
Når du deler en samtale, MakCode:
...
MakCode støtter tre delingsmoduser som kontrollerer hvordan samtaler deles:

---

### Manuel (standard)

Som standard bruger MakCode manuell delingsmodus. Sessioner deles ikke automatisk, men du kan dele dem manuelt ved at bruge kommandoen `/share`:
