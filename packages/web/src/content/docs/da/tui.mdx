---
title: TUI
description: Brug af MakCode-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

MakCode giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre MakCode starter TUI for den nuværende mappe.
...
Når du bruger MakCode TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til MakCode. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut MakCode. _Aliaser_: `/quit`, `/q`
...
- `leader_timeout` - Styrer hvor længe MakCode venter efter leader key. Standard er `2000`.
