...
import type { UpdaterState } from "@makcode-ai/app/updater"
...
const deepLinkEvent = "makcode:deep-link"
  ...
  return {
    ...
    notify: async (title, description, href) => {
      ...
      const notification = new Notification(title, {
        body: description ?? "",
        icon: "https://makcode.ai/favicon-96x96-v3.png",
      })
...
function DesktopRoot(props: { windowState: DesktopWindowState }) {
  ...
  const loadLocale = async () => {
    const current = await platform.storage?.("makcode.global.dat").getItem("language")
