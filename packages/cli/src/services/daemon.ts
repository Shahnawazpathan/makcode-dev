...
import { createOpencodeClient } from "@makcode-ai/sdk/v2/client"
import { ServerAuth } from "@makcode-ai/server/auth"
...
export class Service extends Context.Service<Service, Interface>()("@makcode/cli/Daemon") {}
