...
import { and, Database, eq, isNull, lt, or, sql } from "@makcode-ai/console-core/drizzle/index.js"
import { KeyTable } from "@makcode-ai/console-core/schema/key.sql.js"
import { BillingTable, LiteTable, SubscriptionTable, UsageTable } from "@makcode-ai/console-core/schema/billing.sql.js"
import { centsToMicroCents } from "@makcode-ai/console-core/util/price.js"
import { getMonthlyBounds, getWeekBounds } from "@makcode-ai/console-core/util/date.js"
import { Identifier } from "@makcode-ai/console-core/identifier.js"
import { Billing } from "@makcode-ai/console-core/billing.js"
import { Actor } from "@makcode-ai/console-core/actor.js"
import { WorkspaceTable } from "@makcode-ai/console-core/schema/workspace.sql.js"
import { ZenData } from "@makcode-ai/console-core/model.js"
import { Subscription } from "@makcode-ai/console-core/subscription.js"
import { BlackData } from "@makcode-ai/console-core/black.js"
import { UserTable } from "@makcode-ai/console-core/schema/user.sql.js"
import { ModelTable } from "@makcode-ai/console-core/schema/model.sql.js"
import { ProviderTable } from "@makcode-ai/console-core/schema/provider.sql.js"
...
import { LiteData } from "@makcode-ai/console-core/lite.js"
...
import { Workspace } from "@makcode-ai/console-core/workspace.js"
...
export async function handler(
      ...
      if (!allowedRegions?.includes("unavailable"))
        throw new RegionError(
          t("zen.api.error.regionNotAllowed", {
            consoleGoUrl: `https://makcode.ai/workspace/${authInfo.workspaceID}/go`,
          }),
        )
    }
    */
  ...
  function validateBilling(authInfo: AuthInfo, modelInfo: ModelInfo): BillingSource {
    ...
    if (opts.modelList === "lite" && authInfo.billing.lite && authInfo.lite) {
      try {
        const consoleGoUrl = `https://makcode.ai/workspace/${authInfo.workspaceID}/go`
    ...
    const billingUrl = `https://makcode.ai/workspace/${authInfo.workspaceID}/billing`
    const membersUrl = `https://makcode.ai/workspace/${authInfo.workspaceID}/members`
