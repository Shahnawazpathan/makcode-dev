...
import compareVideo from "../../asset/lander/makcode-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/makcode-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="makcode:auth" content={loggedin() ? "true" : "false"} />
