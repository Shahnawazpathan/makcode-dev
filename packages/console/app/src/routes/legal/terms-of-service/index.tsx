...
export default function TermsOfService() {
  ...
  return (
    <main data-page="legal">
      <Title>MakCode | Terms of Service</Title>
      <LocaleLinks path="/legal/terms-of-service" />
      <Meta name="description" content="MakCode terms of service" />
        ...
        <div data-component="content">
          <section data-component="brand-content">
            <article data-component="terms-of-service">
              ...
              <p>
                Welcome to MakCode. Please read on to learn the rules and restrictions that govern your use of
                MakCode&apos;s website, inference product and hosted software offering (the "Services"). If you have
              ...
              <p>
                ...
                <strong>ANOMALY INNOVATIONS, INC.</strong> ("MakCode," "we" and "us"). Your use of the Services in any
                ...
                <a href={language.route("/legal/privacy-policy")}>https://makcode.ai/legal/privacy-policy</a>.{" "}
                <strong>
              ...
              <p>
                ...
                Models") and certain of these models are provided directly by us if you use the MakCode Zen paid
                offering ("Zen"). Regardless of whether you use Third Party Models or Zen, MakCode enables you to
              ...
              <p>
                ...
                our site located at makcode.ai, send you an email, and/or notify you by some other means.
              </p>
              ...
              <p>
                MakCode takes the privacy of its users very seriously. For the current MakCode Privacy Policy, please
                click here{" "}
                <a href="https://makcode.ai/legal/privacy-policy">https://makcode.ai/legal/privacy-policy</a>.
              </p>
              ...
              <h2 id="what-are-the-basics">What are the basics of using MakCode?</h2>
              <p>
              ...
              <ol style="list-style-type: lower-alpha;">
                ...
                <li>
                  ...
                  privacy laws or any other purpose not reasonably intended by MakCode;
                </li>
                <li>
              ...
              <p>
                If you use MakCode with Third Party Models, then your Content will be subject to the data retention
              ...
              <p>
                ...
                MakCode. Your ability to access Third Party Models is contingent on you having API keys or otherwise
                having the right to access such Third Party Models.
              </p>

              <p>
                MakCode has no control over, and assumes no responsibility for, the content, accuracy, privacy
              ...
              <p>
                ...
                <a href={language.route("/zen")}>https://makcode.ai/zen</a> for a description of the current Paid
              ...
              <p>
                ...
                <a href="https://makcode.ai/auth">https://makcode.ai/auth</a>.
              </p>
              ...
              <p>
                ...
                <a href={language.route("/legal/privacy-policy")}>https://makcode.ai/legal/privacy-policy</a>, as well
                as the licenses above, to understand how we treat information you provide to us after you have stopped
                using our Services.
              </p>

              <p>
                MakCode is also free to terminate (or suspend access to) your use of the Services for any reason in our
                discretion, including your breach of these Terms. MakCode has the sole right to decide whether you are
              ...
              <p>
                MakCode and its licensors, suppliers, partners, parent, subsidiaries or affiliated entities, and each
                of their respective officers, directors, members, employees, consultants, contract employees,
                representatives and agents, and each of their respective successors and assigns (MakCode and all such
                parties together, the "MakCode Parties") make no representations or warranties concerning the Services,
                including without limitation regarding any Content contained in or accessed through the Services, and
                the MakCode Parties will not be responsible or liable for the accuracy, copyright compliance, legality,
                ...
                participation in, the Services. The MakCode Parties make no representations or warranties regarding
              ...
              <h3>Indemnity</h3>
              <p>
                You agree to indemnify and hold the MakCode Parties harmless from and against any and all claims,
              ...
              <p>
                ...
                Services account, in any way (by operation of law or otherwise) without MakCode's prior written
              ...
              <p>
                ...
                disputes and claims with MakCode and limits the manner in which you can seek relief from MakCode. Both
                you and MakCode acknowledge and agree that for the purposes of any dispute arising out of or relating
                to the subject matter of these Terms, MakCode's officers, directors, employees and independent
              ...
              <p>
                The Rules will govern payment of all arbitration fees. MakCode will pay all arbitration fees for claims
                less than seventy-five thousand ($75,000) dollars. MakCode will not seek its attorneys' fees and costs
                in arbitration unless the arbitrator determines that your claim is frivolous.
              </p>

              <h4>Small Claims Court; Infringement</h4>
              <p>
                Either you or MakCode may assert claims, if they qualify, in small claims court in New Castle County,
              ...
              <p>
                ...
                OF A JUDGE OR JURY. You and MakCode are instead choosing to have claims and disputes resolved by
                ...
                you and MakCode over whether to vacate or enforce an arbitration award, YOU AND OPENCODE WAIVE ALL
              ...
              <p>
                ...
                MakCode is entitled to arbitration; instead all claims and disputes will be resolved in a court as set
                forth in (g) below.
              </p>
              ...
              <p>
                ...
                agreement permits either you or MakCode to litigate any dispute arising out of or relating to the
                subject matter of these Terms in court, then the foregoing arbitration agreement will not apply to
                either party, and both you and MakCode agree that any judicial proceeding (other than small claims
              ...
              <p>
                ...
                the MakCode may, in its sole discretion, do any of the foregoing on your behalf or for itself as it
                ...
                Terms shall otherwise remain in full force and effect and enforceable. You and MakCode agree that these
                Terms are the complete and exclusive statement of the mutual understanding between you and MakCode, and
                ...
                are not an employee, agent, partner, or joint venture of MakCode, and you do not have any authority of
                any kind to bind MakCode in any respect whatsoever.
              </p>

              <p>
                Except as expressly set forth in the section above regarding the arbitration agreement, you and MakCode
