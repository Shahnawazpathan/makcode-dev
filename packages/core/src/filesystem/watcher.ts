...
import { FileSystemWatcher } from "@makcode-ai/schema/filesystem-watcher"
...
export class Service extends Context.Service<Service, Interface>()("@makcode/v2/FileWatcher") {}
