...
import type { Data, Definition, Payload } from "@makcode-ai/schema/event"
...
import { Durable } from "@makcode-ai/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@makcode-ai/schema/event").ID
export type { Data, Definition, Payload } from "@makcode-ai/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@makcode/Event") {}
