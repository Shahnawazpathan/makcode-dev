...
import { PermissionSaved } from "@makcode-ai/schema/permission-saved"
...
export class Service extends Context.Service<Service, Interface>()("@makcode/v2/PermissionSaved") {}
