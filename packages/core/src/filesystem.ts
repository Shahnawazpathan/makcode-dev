...
import { Entry, FileSystem, FindInput, Match } from "@makcode-ai/schema/filesystem"
export { Entry, Match, Submatch } from "@makcode-ai/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@makcode/v2/FileSystem") {}
