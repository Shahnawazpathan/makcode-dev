...
import { ListAnchor } from "@makcode-ai/schema/session"
...
import { SessionDurable } from "@makcode-ai/schema/durable-event-manifest"
...
export class Service extends Context.Service<Service, Interface>()("@makcode/v2/Session") {}
