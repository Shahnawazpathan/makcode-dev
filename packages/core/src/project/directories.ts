...
import type { EffectDrizzleSqlite } from "@makcode-ai/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@makcode/ProjectDirectories") {}
