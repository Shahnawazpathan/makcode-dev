...
import { Event } from "@makcode-ai/schema/project-directories"
import { ProjectCopy } from "@makcode-ai/schema/project-copy"
...
export class Service extends Context.Service<Service, Interface>()("@makcode/ProjectCopy") {}
