export * as MakCode from "./makcode"
...
/** Intentional public native API for Effect applications embedding MakCode. */
export class Service extends Context.Service<Service, Interface>()("@makcode/public/MakCode") {}
...
// TODO: Add MakCode.create(...) as the Promise facade over the same native API semantics.
