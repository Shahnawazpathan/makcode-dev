...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@makcode-ai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@makcode/v2/ToolRegistry") {}
