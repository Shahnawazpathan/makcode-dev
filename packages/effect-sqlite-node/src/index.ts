...
export const TypeId: TypeId = "~@makcode-ai/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@makcode-ai/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@makcode-ai/effect-sqlite-node/NodeSqliteClient")
