export const dict = {
  "app.title": "Classifiche di utilizzo dei modelli IA | MakCode Data",
  "app.description":
    "Esplora l'utilizzo di MakCode Go nei modelli IA, inclusi volume di token, classifiche, quota di mercato, prezzi dei token, costo per sessione, rapporto cache e ripartizioni geografiche.",
  "app.unfurlAlt": "Logotipo MakCode Data su uno sfondo scuro con motivo",
  ...
  "header.githubAria": "Aggiungi una stella a MakCode su GitHub",
  "header.github": "GitHub",
  "header.tryMakCode": "Prova MakCode",
  ...
  "home.topModelsDescription": "Utilizzo dei modelli in MakCode Go.",
  ...
  "home.uniqueUsersDescription": "Utenti unici giornalieri di MakCode Go per modello.",
  ...
  "lab.title": "Utilizzo e classifiche dei modelli IA {{lab}} | MakCode Data",
  "lab.description":
    "Confronta i modelli {{lab}} usati in MakCode Go, inclusi utilizzo dei token, classifiche dei modelli, finestre di contesto, date di rilascio, costi e dati specifici del modello.",
  "lab.loadingTitle": "Laboratorio modelli",
  "lab.loadingDescription": "Lettura della disponibilità dei modelli e dell'utilizzo recente di MakCode.",
  "lab.notFound": "Nessun modello corrispondeva a questo laboratorio.",
  "lab.heroPrefix": "Esplora {{count}} modelli {{lab}} usati in MakCode",
  ...
  "lab.shareOfUsage": "{{share}} dell'utilizzo recente di MakCode",
  "lab.usageTitle": "Utilizzo token {{lab}}",
  "lab.usageDescription": "Volume giornaliero di token MakCode negli ultimi due mesi.",
  ...
  "lab.usage": "Utilizzo",
  "lab.share": "Quota",
  "model.title": "Utilizzo, costo e posizione di {{model}} | MakCode Data",
  "model.description":
    "Visualizza i dati di utilizzo di {{model}} in MakCode Go, inclusi volume di token, rango settimanale, mix di token, costi, rapporto cache, sessioni, ripartizioni geografiche e modelli simili.",
  ...
  "model.catalogFallback":
    "Fatti del modello dall'indice condiviso dei modelli. L'utilizzo di MakCode Go appare quando questo modello ha attività.",
  "model.unranked": "Non classificato nell'utilizzo MakCode Go della scorsa settimana",
  "model.ranked": "Posizione #{{rank}} nell'utilizzo MakCode Go della scorsa settimana",
  ...
  "model.noCurrentUsage": "Nessun utilizzo di MakCode Go nella finestra dati attuale.",
  ...
  "model.inputs": "Input",
  "model.overviewDescription": "Token recenti di MakCode Go, utenti unici e posizione di mercato.",
  "model.noSummaryTitle": "Nessun riepilogo di utilizzo",
  "model.noSummaryDescription": "Questo modello non ha ancora righe di utilizzo di MakCode Go.",
  "model.tokens": "Token",
  ...
  "model.usageDescription": "Volume giornaliero di token MakCode Go nella recente finestra di due mesi.",
  ...
  "model.usersDescription": "Utenti unici giornalieri di MakCode Go nella recente finestra di due mesi.",
  ...
  "model.efficiencyDescription": "Costi, comportamento della cache e forma media della sessione MakCode Go.",
  ...
  "model.geoDescription": "Token del modello MakCode Go usati per paese.",
  "model.noGeoTitle": "Nessun dato geografico",
  "model.noGeoDescription": "Nessuna riga geografica MakCode Go corrispondeva a questo modello.",
  "model.worldMap": "Mappa mondiale dell'utilizzo dei token del modello per paese",
  "model.peersDescription": "Modelli vicini per volume recente di token MakCode Go.",
