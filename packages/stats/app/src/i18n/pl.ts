export const dict = {
  "app.title": "Rankingi użycia modeli AI | MakCode Data",
  "app.description":
    "Przeglądaj użycie MakCode Go w modelach AI, w tym wolumen tokenów, rankingi, udział w rynku, ceny tokenów, koszt sesji, współczynnik cache i podziały geograficzne.",
  "app.unfurlAlt": "Znak słowny MakCode Data na ciemnym wzorzystym tle",
  ...
  "header.githubAria": "Dodaj gwiazdkę MakCode na GitHub",
  "header.github": "GitHub",
  "header.tryMakCode": "Wypróbuj MakCode",
  ...
  "footer.homeAria": "Strona główna MakCode",
  ...
  "home.topModelsDescription": "Użycie modeli w MakCode Go.",
  ...
  "home.uniqueUsersDescription": "Dzienni unikalni użytkownicy MakCode Go według modelu.",
  ...
  "lab.title": "Użycie i rankingi modeli AI {{lab}} | MakCode Data",
  "lab.description":
    "Porównaj modele {{lab}} używane w MakCode Go, w tym użycie tokenów, rankingi modeli, okna kontekstu, daty wydań, koszty i dane specyficzne dla modeli.",
  "lab.loadingTitle": "Laboratorium modeli",
  "lab.loadingDescription": "Odczytywanie dostępności modeli i ostatniego użycia MakCode.",
  "lab.notFound": "Żadne modele nie pasowały do tego laboratorium.",
  "lab.heroPrefix": "Przeglądaj {{count}} modeli {{lab}} używanych w MakCode",
  ...
  "lab.shareOfUsage": "{{share}} ostatniego użycia MakCode",
  "lab.usageTitle": "Użycie tokenów {{lab}}",
  "lab.usageDescription": "Dzienny wolumen tokenów MakCode z ostatnich dwóch miesięcy.",
  ...
  "lab.usage": "Użycie",
  "lab.share": "Udział",
  "model.title": "Użycie, koszt i pozycja {{model}} | MakCode Data",
  "model.description":
    "Zobacz dane użycia {{model}} w MakCode Go, w tym wolumen tokenów, tygodniową pozycję, miks tokenów, koszty, współczynnik cache, sesje, podziały geograficzne i podobne modele.",
  ...
  "model.catalogFallback":
    "Fakty modelu ze wspólnego indeksu modeli. Użycie MakCode Go pojawi się, gdy ten model będzie mieć aktywność.",
  "model.unranked": "Bez pozycji w użyciu MakCode Go z zeszłego tygodnia",
  "model.ranked": "Pozycja #{{rank}} w użyciu MakCode Go z zeszłego tygodnia",
  ...
  "model.noCurrentUsage": "Brak użycia MakCode Go w bieżącym oknie danych.",
  ...
  "model.overviewDescription": "Ostatnie tokeny MakCode Go, unikalni użytkownicy i pozycja rynkowa.",
  "model.noSummaryTitle": "Brak podsumowania użycia",
  "model.noSummaryDescription": "Ten model nie ma jeszcze wierszy użycia MakCode Go.",
  "model.tokens": "Tokeny",
  ...
  "model.usageDescription": "Dzienny wolumen tokenów MakCode Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.usersDescription": "Dzienni unikalni użytkownicy MakCode Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.efficiencyDescription": "Koszt, zachowanie cache i średni kształt sesji MakCode Go.",
  ...
  "model.geoDescription": "Tokeny modelu MakCode Go użyte według kraju.",
  "model.noGeoTitle": "Brak danych geograficznych",
  "model.noGeoDescription": "Żadne wiersze geograficzne MakCode Go nie pasowały do tego modelu.",
  "model.worldMap": "Mapa świata użycia tokenów modelu według kraju",
  "model.peersDescription": "Pobliskie modele według ostatniego wolumenu tokenów MakCode Go.",
