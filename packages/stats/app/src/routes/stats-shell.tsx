...
export const githubLink = {
  ...
  apiHref: "https://api.github.com/repos/shahnawaz-pathan/makcode",
  label: "GitHub",
  fallbackStars: "150K",
  ariaLabel: "Star MakCode on GitHub",
}
    ...
    <header data-component="top" data-menu-open={menuOpen() ? "true" : undefined}>
      <div data-slot="header-bar">
        ...
        <div data-slot="header-actions">
          ...
          <a data-slot="header-button" data-variant="contrast" href="https://makcode.ai/">
            <strong>Try MakCode</strong>
          </a>
          <button
...
export function Footer(props: {
  ...
  const legal = [
    { href: "https://makcode.ai/legal/terms-of-service", label: "Terms of service" },
    { href: "https://makcode.ai/legal/privacy-policy", label: "Privacy policy" },
  ]
  const connect = [
    { href: "mailto:hello@makcode.ai", label: "Contact us" },
    { href: "https://makcode.ai/discord", label: "Community" },
  ...
  return (
    <footer data-component="footer">
      ...
      <div data-slot="footer-grid">
        <a data-slot="footer-mark" href="https://makcode.ai" aria-label="MakCode home">
          <MakCodeMark />
        </a>
      ...
      <div data-slot="modal-panel">
        ...
        <div data-slot="modal-body">
          <div data-slot="modal-intro">
            <h2 id="subscribe-title">MakCode Newsletter</h2>
            <p>
