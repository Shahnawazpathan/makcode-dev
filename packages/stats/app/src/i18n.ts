...
const en = {
  "app.title": "AI Model Usage Rankings | MakCode Data",
  "app.description":
  ...
  "app.unfurlAlt": "MakCode Data wordmark on a dark patterned background",
  ...
  "header.githubAria": "Star MakCode on GitHub",
  "header.github": "GitHub",
  "header.tryMakCode": "Try MakCode",
  ...
  "home.topModelsDescription": "Usage of models across MakCode Go.",
  ...
  "home.uniqueUsersDescription": "Daily unique MakCode Go users by model.",
  ...
  "lab.title": "{{lab}} AI Model Usage & Rankings | MakCode Data",
  "lab.description":
    "Compare {{lab}} models used in MakCode Go, including token usage, model rankings, context windows, release dates, costs, and model-specific data.",
  "lab.loadingTitle": "Model Lab",
  "lab.loadingDescription": "Reading model availability and recent MakCode usage.",
  "lab.notFound": "No models matched this lab.",
  "lab.heroPrefix": "Explore {{count}} {{lab}} models used in MakCode",
  ...
  "lab.shareOfUsage": "{{share}} of recent MakCode usage",
  ...
  "lab.usage": "Usage",
  "lab.share": "Share",
  "model.title": "{{model}} Usage, Cost & Rank | MakCode Data",
  "model.description":
    "View {{model}} MakCode Go usage data, including token volume, weekly rank, token mix, costs, cache ratio, sessions, geo breakdowns, and peer models.",
  ...
  "model.catalogFallback":
    "Model facts from the shared model index. MakCode Go usage appears once this model has activity.",
  "model.unranked": "Unranked across last week's MakCode Go usage",
  "model.ranked": "Ranked #{{rank}} across last week's MakCode Go usage",
  "model.observedVolume": "with {{share}} of observed 2M volume.",
  "model.weights": "Model weights: {{label}}",
  "model.rank": "7D Rank",
  "model.profile": "Model Profile",
  "model.listed": "Listed",
  "model.noCurrentUsage": "No MakCode Go usage in the current data window.",
  ...
  "model.noSummaryDescription": "This model has no MakCode Go usage rows yet.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Daily MakCode Go token volume over the recent two-month window.",
  ...
  "model.usersDescription": "Daily unique MakCode Go users over the recent two-month window.",
  ...
  "model.efficiencyDescription": "Cost, cache behavior, and average MakCode Go session shape.",
  ...
  "model.geoDescription": "MakCode Go model tokens used by country.",
  "model.noGeoTitle": "No geo data",
  "model.noGeoDescription": "No MakCode Go geo rows matched this model.",
  "model.worldMap": "World map of model token usage by country",
  "model.peersDescription": "Nearby models by recent MakCode Go token volume.",
