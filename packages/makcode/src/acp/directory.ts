...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@makcode/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@makcode/ACPDirectory") {}
