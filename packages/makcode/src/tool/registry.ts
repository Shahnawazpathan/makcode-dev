...
import { type ToolContext as PluginToolContext, type ToolDefinition } from "@makcode-ai/plugin"
...
export function webSearchEnabled(providerID: ProviderV2.ID, flags = { exa: false, parallel: false }) {
  return providerID === ProviderV2.ID.makcode || flags.exa || flags.parallel
}
