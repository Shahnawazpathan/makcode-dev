// Shared type vocabulary for the direct interactive mode (`makcode --mini`).
//
...
import type { OpencodeClient, PermissionRequest, QuestionRequest, ToolPart } from "@makcode-ai/sdk/v2"
