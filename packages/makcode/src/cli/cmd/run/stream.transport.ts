...
import type { Event, GlobalEvent, OpencodeClient } from "@makcode-ai/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@makcode/RunStreamTransport") {}
