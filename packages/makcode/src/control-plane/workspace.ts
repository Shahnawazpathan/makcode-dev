...
import { EventSequenceTable, EventTable } from "@makcode-ai/core/event/sql"
...
import { WorkspaceEvent } from "@makcode-ai/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@makcode/Workspace") {}
