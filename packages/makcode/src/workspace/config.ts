...
export function context(config: Config) {
  ...
  return [
    ...
    "Treat the frontend and backend as one product module.",
    "If the user asks for backend work and a frontend project is configured, inspect the frontend API clients, pages, forms, state, and types that consume the changed backend behavior.",
    "Implement the complete feature across both projects when the requested module requires backend and frontend changes, without waiting for separate frontend instructions.",
