...
import type { ProviderMetadata, Usage } from "@makcode-ai/llm"
...
import { locationServiceMapLayer } from "@makcode-ai/core/location-services"
...
import { PartTable, SessionTable } from "@makcode-ai/core/session/sql"
...
import { NonNegativeInt, optional } from "@makcode-ai/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".makcode", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@makcode/Session") {}
