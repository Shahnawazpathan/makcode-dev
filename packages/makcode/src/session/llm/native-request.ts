import type { JsonSchema, LLMRequest, ProviderMetadata } from "@makcode-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@makcode-ai/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @makcode-ai/llm request objects from opencode's session/AI SDK-shaped data.
  return LLM.request({
