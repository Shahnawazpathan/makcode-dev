import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@makcode-ai/llm"
...
// Move this extraction into @makcode-ai/llm when Copilot is handled by the native runtime.
