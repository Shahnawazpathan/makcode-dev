import type { Hooks, PluginInput } from "@makcode-ai/plugin"
import type { Model } from "@makcode-ai/sdk/v2"
...
<html>
  <head>
    <meta charset="utf-8" />
    <title>MakCode - DigitalOcean Authorization</title>
    <style>
    ...
    <script>
      (async function() {
        ...
        try {
          ...
          msgEl.textContent = "You can close this window and return to MakCode."
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              url,
              instructions:
                "Sign in to DigitalOcean in your browser. MakCode will use your DigitalOcean API token directly for inference and load your Inference Routers. Re-run /connect to refresh routers later.",
