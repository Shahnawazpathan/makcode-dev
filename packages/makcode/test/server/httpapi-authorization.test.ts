...
const noAuthLayer = ServerAuth.Config.layer({ password: Option.none(), username: "makcode" })
const secretLayer = ServerAuth.Config.layer({ password: Option.some("secret"), username: "makcode" })
