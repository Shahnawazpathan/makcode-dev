...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips makcode-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-makcode-directory"]).toBeUndefined()
      expect(forwarded["x-makcode-workspace"]).toBeUndefined()
