...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips makcode-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-makcode-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-makcode-directory")).toBeNull()
      expect(result.get("x-makcode-workspace")).toBeNull()
