...
Practical reference for the current tool-migration state in `packages/makcode`.
...
Tool tests should use the existing Effect helpers in `packages/makcode/test/lib/effect.ts`:
