...
```
REGISTRY=ghcr.io/shahnawaz-pathan TAG=24.04 bun ./packages/containers/script/build.ts
REGISTRY=ghcr.io/shahnawaz-pathan TAG=24.04 bun ./packages/containers/script/build.ts --push
```
...
jobs:
  build-cli:
    ...
    container:
      image: ghcr.io/shahnawaz-pathan/build/bun-node:24.04
```
