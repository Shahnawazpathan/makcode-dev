...
Schema-first LLM core for makcode. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@makcode-ai/llm"
import { OpenAI } from "@makcode-ai/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@makcode-ai/llm/providers"
