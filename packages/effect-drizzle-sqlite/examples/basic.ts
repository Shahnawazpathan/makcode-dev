...
class Database extends Context.Service<Database, DatabaseShape>()("@makcode/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@makcode/example/UserStore") {
