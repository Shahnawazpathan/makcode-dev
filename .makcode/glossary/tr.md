...
- PR #15835: https://github.com/anomalyco/makcode/pull/15835

## Do Not Translate (Locale Additions)

- `MakCode` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `makcode` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `MakCode` in prose, `makcode` only for exact technical identifiers
...
- Avoid changing `makcode` to `MakCode` inside commands, URLs, package names, or code literals
