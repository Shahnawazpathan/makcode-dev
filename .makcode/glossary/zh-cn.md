...
- PR #13942: https://github.com/anomalyco/makcode/pull/13942

## Do Not Translate (Locale Additions)

- `MakCode` (preserve casing in prose; keep `makcode` only when it is part of commands, package names, paths, or code)
- `MakCode Zen`
- `MakCode CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `makcode` in prose when referring to the product name; use `MakCode`
