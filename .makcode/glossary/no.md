...
- PR #10018: https://github.com/anomalyco/makcode/pull/10018
- PR #12935: https://github.com/anomalyco/makcode/pull/12935

## Do Not Translate (Locale Additions)

- `MakCode` (preserve casing in prose; keep `makcode` only in commands, package names, paths, or code)
- `MakCode CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
