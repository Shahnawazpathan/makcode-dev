...
Use this folder for locale-specific translation guidance that supplements `.makcode/agent/translator.md`.
...
- PR #12345: https://github.com/anomalyco/makcode/pull/12345

## Do Not Translate (Locale Additions)

- `MakCode` (preserve casing)
