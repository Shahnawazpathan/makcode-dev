...
brew install shahnawaz-pathan/tap/makcode # macOS og Linux (anbefalt, alltid oppdatert)
brew install makcode              # macOS og Linux (offisiell brew-formel, oppdateres sjeldnere)
...
MakCode har to innebygde agents du kan bytte mellom med `Tab`-tasten.
...
Hvis du vil bidra til MakCode, les [contributing docs](./CONTRIBUTING.md) før du sender en pull request.

### Bygge på MakCode

Hvis du jobber med et prosjekt som er relatert til MakCode og bruker "makcode" som en del av navnet; for eksempel "makcode-dashboard" eller "makcode-mobile", legg inn en merknad i README som presiserer at det ikke er bygget av MakCode-teamet og ikke er tilknyttet oss på noen måte.

---

**Bli med i fellesskapet** [Discord](https://discord.gg/makcode) | [X.com](https://x.com/makcode)
